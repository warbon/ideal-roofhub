...
<template>
  <div class="bg-white">
        ...
        <div class="px-6 pt-6 lg:max-w-2xl lg:pl-8 lg:pr-0">
          <nav class="flex items-center justify-between lg:justify-start" aria-label="Global">
            <a href="#" class="-m-1.5 p-1.5">
              <span class="sr-only">Ideal Roof Hub</span>
              <img alt="Ideal Roof Hub" class="h-8 w-auto" src="./assets/images/irh02-trans.png?color=indigo&shade=600" />
            </a>
    ...
    <div class="relative">
      <div class="mx-auto max-w-7xl">
        <div class="relative z-10 pt-2 lg:w-full lg:max-w-2xl">
          ...
          <div class="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
            <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
              ...
              <img src="./assets/images/ideal-roof-hub-trans.png" />
              <p class="mt-6 text-lg leading-8 text-gray-600">At Ideal RoofHub, we believe in providing more than just roofs; we offer a promise of enduring protection and timeless beauty for your home. With a steadfast commitment to quality, innovation, and sustainability, we bring you the finest roofing solutions, anchored by our exceptional Stone Coated Roof Tiles.</p>
      ...
      <div class="bg-gray-50 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img class="aspect-[3/2] object-cover lg:aspect-auto lg:h-full lg:w-full" src="./assets/images/home-header.jpg?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1587&q=80" alt="" />
      </div>
    </div>
          ...
          <div v-for="feature in primaryFeatures" :key="feature.name" class="pt-6">
            <div class="flow-root rounded-lg bg-gray-50 px-6 pb-8 opacity-80">
              <div class="-mt-6">
                ...
                <h3 class="mt-8 text-lg font-semibold leading-8 tracking-tight text-gray-900">{{ feature.name }}</h3>
  ...
  <div class="overflow-hidden bg-gray-50 py-16 lg:py-24">
    <div class="relative mx-auto max-w-xl px-6 lg:max-w-7xl lg:px-8">
      ...
      <div class="relative">
        <h2 class="text-center text-3xl font-bold leading-8 tracking-tight text-gray-900 sm:text-4xl">Beyond Roofs: Crafting Dreams, Building Realities</h2>
        <p class="mx-auto mt-4 max-w-3xl text-center text-xl text-gray-500">Ideal RoofHub isn't just about roofs; it's about transforming spaces and building dreams. We're not just experts in Stone Coated Roof Tiles; we're masters of construction. From interior fit-outs that redefine spaces to architectural designs that encapsulate visions, from meticulous design and build services to exquisite furniture making, we craft experiences that resonate with perfection.</p>
        <p class="mx-auto mt-4 max-w-3xl text-center text-xl text-gray-500">Explore our other services:</p>
      </div>
      ...
      <div class="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
        ...
        <div class="relative -mx-4 mt-10 lg:mt-0" aria-hidden="true">
          ...
          <img class="relative mx-auto" width="490" src="./assets/images/03.jpg" alt="" />
        </div>
      </div>
...
{
    name: 'Roofs That Last a Lifetime',
    description: 'Our Stone Coated Roof Tiles are not just roofs; they are legacies. Crafted with precision and fortified with durability, our roofs are designed to accompany you through generations.',
    icon: CloudArrowUpIcon,
  },
  {
    name: '25-Year Warranty',
    description: 'We believe in the quality of our craftsmanship. That is why we offer a 25-year warranty against corrosion and surface coating, ensuring your investment is secure and protected.',
    icon: LockClosedIcon,
  },
  {
    name: 'Anti-Leak Technology',
    description: 'Rain or shine, your comfort remains intact. Our anti-leak roofing solutions ensure that your home is a fortress of dryness even during the heaviest storms.',
    icon: ArrowPathIcon,
  },
  {
    name: 'Anti-Theft Features',
    description: 'We understand the importance of security. Our roofs come equipped with anti-theft features, deterring any unauthorized access and giving you peace of mind.',
    icon: ShieldCheckIcon,
  },
  {
    name: 'Eco-Friendly',
    description: 'Sustainability is not just a buzzword; it is our commitment. Our Stone Coated Roof Tiles are not only enduring but also environmentally conscious, contributing to a greener planet.',
    icon: CogIcon,
  },
  {
    name: 'Lightweight Elegance',
    description: 'The beauty of our roofs lies not only in their resilience but also in their lightweight design, ensuring structural integrity without unnecessary weight.',
    icon: ServerIcon,
  },
]
